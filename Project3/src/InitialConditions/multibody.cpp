...
void MultiBody::setupParticles(System &system) {
    ...
    /*
     * In our project we use 10 particles.
     * This includes all planets in the solar system,
     * plus the sun and Pluto.
     * The moon is declared and initialized but not plotted later
     */
